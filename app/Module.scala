import dto.request.examResult.jsonParser.studentIdRequestConverter.impl.StudentIdRequestConverterImpl
import dto.request.examResult.jsonParser.studentIdRequestConverter.`trait`.StudentIdRequestConverter
import dto.request.examResult.jsonParser.scoreRequestConverter.impl.ScoreRequestConverterImpl
import dto.request.examResult.jsonParser.scoreRequestConverter.`trait`.ScoreRequestConverter
import dto.request.examResult.jsonParser.examResultIdRequestConverter.impl.ExamResultIdRequestConverterImpl
...
import dto.request.examResult.jsonParser.evaluationRequestConverter.impl.EvaluationRequestConverterImpl
import dto.request.examResult.jsonParser.examResultIdRequestConverter.impl.ExamResultIdRequestConverterImpl
import dto.request.examResult.jsonParser.scoreRequestConverter.impl.ScoreRequestConverterImpl
import dto.request.examResult.jsonParser.studentIdRequestConverter.`trait`.StudentIdRequestConverter
